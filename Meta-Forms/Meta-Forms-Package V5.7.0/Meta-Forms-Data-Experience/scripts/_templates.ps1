...
$ConnectionsOptions                   = '{{"server":"{0}","useHttps":{1},"userId":"{2}","password":"{3}","model":"{4}","feed":"{5}","batchsize":{6},"retrievalbatchsize":{7},"writeToFile":{8}{9}}}'
$ConnectionsParamValues               = ',"paramValues":{{{0}}}'
$ConnectionsParam                     = '"{0}":{{"isFile":{1},"value":"{2}"}}'
